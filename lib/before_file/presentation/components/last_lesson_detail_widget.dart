...
class LastLessonDetailWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> messages = [
      ...
      {
        'id': 1,
        'text': 'not too bad.. have you had a dinner?',
        'time': '10:00 AM'
      },
      {
        'id': 2,
        'text': 'not really, I am planning to. how about you?',
        'time': '10:01 AM'
      },
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('\$date 일차 수업 상세보기'),
              ...
              showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content: const Text('AI 피드백은 유료서비스 입니다. 결제하시겠습니까?'),
                    actions: <Widget>[
                      TextButton(
                        onPressed: () {
          ...
          return Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isMe ? const Color(0xFF91A7E8) : Colors.grey[300],
                borderRadius: isMe
