...
class _HomeScreenState extends State<HomeScreen> {
              ...
              return Container(
                ...
                child: Column(
                  children: [
                    ElevatedButton(
                        onPressed: () {
                          // _firebaseStoreService.updateProfile('userId');
                        },
                        child: Text('프로필 추가')),
  ...
  Future<Profile> fetchProfile(String profileId) async {
    ...
    if (doc.exists) {
      ...
      print('Requested profile ID: $profileId does not exist.');
      throw Exception('Profile not found!');
    }
  }

  // Future<void> addNewProfile(String profileId) async {
  //   // 새 프로필 생성
  ...
  //   );
  //
  //   // Firestore에 프로필 추가 (가정)
  //   _firebaseStoreService.addProfile(newProfile).catchError((error){
  //     print('Error adding profile: $error');
  //   });  // Firestore 서비스의 메소드 가정
  //   setState(() {
